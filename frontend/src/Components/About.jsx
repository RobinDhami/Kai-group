  ...
  return (
    <section className="py-8 bg-gray-100">
      <div className="container mx-auto">
        <div className="mb-12">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-4" style={{ fontFamily: 'Yeseva One, serif' }}>About Neem Karoli Trust</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div>
            <h3 className="text-3xl font-bold text-gray-800 mb-4" style={{ fontFamily: 'Yeseva One, serif' }}>Our Mission</h3>
          ...
          <div>
            <h3 className="text-3xl font-bold text-gray-800 mb-4" style={{ fontFamily: 'Yeseva One, serif' }}>Our Vision</h3>
            <p className="text-lg text-gray-700 mb-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vestibulum, quam quis pulvinar lobortis, mi justo pharetra urna, eget fermentum turpis erat vel nulla. Nullam bibendum scelerisque arcu ut pulvinar.</p>
          </div>
          <div>
            <h3 className="text-3xl font-bold text-gray-800 mb-4" style={{ fontFamily: 'Yeseva One, serif' }}>Goals and Objectives</h3>
            <p className="text-lg text-gray-700 mb-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vestibulum, quam quis pulvinar lobortis, mi justo pharetra urna, eget fermentum turpis erat vel nulla. Nullam bibendum scelerisque arcu ut pulvinar.</p>
          </div>
        </div>
