      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-xl font-bold text-[#AE402D] mb-2" style={{ fontFamily: 'Yeseva One, serif' }}>Programs </h3>
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-xl font-bold text-[#AE402D] mb-2" style={{ fontFamily: 'Yeseva One, serif' }}>FAQ</h3>
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-xl font-bold text-[#AE402D] mb-2" style={{ fontFamily: 'Yeseva One, serif' }}>Donate</h3>
            <p className="text-gray-700">Support our cause by making a donation. Every contribution helps us make a difference.</p>
          </div>
          <div className="flex flex-col items-center">
            <FontAwesomeIcon icon={faHandsHelping} className="text-4xl text-[#FFA302] mb-4" />
            <h3 className="text-xl font-bold text-[#AE402D] mb-2" style={{ fontFamily: 'Yeseva One, serif' }}>Get Involved</h3>
